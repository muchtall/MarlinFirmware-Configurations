...
#define STRING_CONFIG_H_AUTHOR "(MuchTall-v20240213131027, CR-10S)" // MUCHTALL - Custom version identification //#define STRING_CONFIG_H_AUTHOR "(printedsolid.com, CR-10S)" // Who made the changes.
