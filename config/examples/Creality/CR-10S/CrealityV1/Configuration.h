...
#define STRING_CONFIG_H_AUTHOR "(MuchTall-v202402121755CDT, CR-10S)" // MUCHTALL - Custom version identification //#define STRING_CONFIG_H_AUTHOR "(printedsolid.com, CR-10S)" // Who made the changes.
