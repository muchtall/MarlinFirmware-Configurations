 ...
 */
  ...
  #define THERMAL_PROTECTION_HYSTERESIS 4     // (°C)		//MUCHTALL - Temps seems to sway as much as 7°C during warm-up with the bi-metal heatbreak //#define THERMAL_PROTECTION_HYSTERESIS 4     // (°C)
