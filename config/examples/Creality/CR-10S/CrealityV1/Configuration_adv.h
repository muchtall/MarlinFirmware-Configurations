 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 60        // (seconds)	//MUCHTALL - In addition to below, seems we need some more leeway for heatup time //#define THERMAL_PROTECTION_PERIOD 40        // (seconds)
  #define THERMAL_PROTECTION_HYSTERESIS 15    // (°C)		//MUCHTALL - Temps seems to sway as much as 15°C during warm-up with the bi-metal heatbreak //#define THERMAL_PROTECTION_HYSTERESIS 4     // (°C)
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_HYSTERESIS     8 // (°C) //MUCHTALL - Give some additional leeway in bed heating to allow for higher target temps //#define THERMAL_PROTECTION_BED_HYSTERESIS     2 // (°C)
 ...
 */
#define LIN_ADVANCE	// MUCHTALL - Enable Linear Advance ////#define LIN_ADVANCE
 ...
 */
#define HOST_ACTION_COMMANDS  // MUCHTALL - Enable host action commands for OctoPrint ////#define HOST_ACTION_COMMANDS
